const intro = () => {
  return (
    ...
    <header class="intro d-flex flex-column justify-content-around m-3">
        ...
        <p><a class="fw-800 btn btn-outline-light btn-lg" href="http://jabirfarah.github.io/portfolio-v1/pdf/Jabir-Farah-Resume.pdf" target="_blank" rel="noreferrer">View Resume <i class="fas fa-arrow-right"></i></a></p>
    </header>
    </>
  )
}
