...
const intro = () => {
  return (
    ...
    <header className="intro flex-column justify-content-around m-3 d-sm-flex">
        <h1 className="intro_hello">Hello! <span className="emoji wave-emoji-animation">👋</span></h1>
        <h2 className="intro-hero">I'm <span className="name">Jabir Farah</span>, a full-stack engineer focused on building beautiful experiences through code 👨🏿‍💻</h2>
        ...
        <div className="container">
          <a className="link linkedin" href='https://linkedin.com/in/jabirfarah' target="_blank" rel="noreferrer">
              <i className="fab fa-2x fa-linkedin"></i>
          </a>

          <a className="link github" href='https://github.com/jabirfarah' target="_blank" rel="noreferrer">
              <i className="fab fa-2x fa-github"></i>
          </a>
          
          <a className="link mail" href='mailto:jabirfarah0@gmail.com' target="_blank" rel="noreferrer">
